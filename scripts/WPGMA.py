...
######################################################################
#                                                                    #
#  WPGMA (Weighted Pair Group Method with Arithmetic Mean) is        #
#  a bottom-up hierarchical clustering method used to construct      #
#  rooted phylogenetic tree. It requires a constant-rate assumption  #
#  and produces an ultrametric tree.                                 #
#                                                                    #
#  It is based on JC69 (Jukes and Cantor 1969) substitution model    #
#  that assumes equal base frequencies and equal mutation rates.     #
#                                                                    #
#  ---------------------------------------------------------------   #
#                                                                    #
#  The phylogenetic tree produced by WPGMA method of MPhylA is       #
#  without branch length estimation and it simply produce a          #
#  Dendrogram                                                        #
#                                                                    #
######################################################################
""")
...
print("Initiating WPGMA tree construction ...", end='')
...
print(" Done")
print("Constructing Distance_Matrix ...", end='')
...
def tree_maker(matrix,list1):
	...
	bl = (str(list1[0])+":"+str((matrix[min_d[0],min_d[1]])/2),str(list1[1])+":"+str((matrix[min_d[0],min_d[1]])/2))
	bl= list(bl)
	return(index)
...
print(" Done")
print("Generating newick tree ...", end = '')
...
# OUTPUT
print("WPGMA tree construction ... Done")
tree_name = "MPhylA_WPGMA_Tree_"+ tree_nm + ".txt"
